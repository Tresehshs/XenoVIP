...
def banner(console):
    ...
    brand_name += "Telegram: @trese_xeno"
    brand_name += "Facebook: Johnsteve Biron"
    
    text = Text(brand_name, style="bold black")
    
    console.print(text)
    console.print("[bold white] ============================================================[/bold white]")
    console.print("[bold red]      𝗣𝗟𝗘𝗔𝗦𝗘 𝗟𝗢𝗚 𝗢𝗨𝗧 𝗙𝗥𝗢𝗠 𝗖𝗣𝗠 𝗕𝗘𝗙𝗢𝗥𝗘 𝗨𝗦𝗜𝗡𝗚 𝗧𝗛𝗜𝗦 𝗧𝗢𝗢𝗟[/bold red]")
