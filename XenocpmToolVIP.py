    ...
    while True:
        ...
        while True:
            ...
            menu_price_list = [
                ...
                ("{44}: Unlock Clan Top 2 (m)         ", "4K"),
                ("{45}: Unlock Clan Top 3 (m)         ", "1K"),
                ("{46}: Unlock Clan Top 1 (fm)        ", "5K"),
                ("{47}: Unlock Clan Top 2 (fm)        ", "2.5K"),
                ("{48}: Unlock Mercedes Cls           ", "7.5K"),
                ("{49}: Car Inlclin                   ", "1K"),
                ("{50}: Unlock All Lambo (IOS Only)   ", "5K"),
                ("{51}: Clone Livery                  ", "2.5K"),
                ("{52}: Custom Hp (All Cars)          ", "7.5K"),
                ("{00}: Exit                          ", ""),
            ]
            ...
            for menu, price in menu_price_list:
                ...
                print(white + code + Colorate.Horizontal(Colors.rainbow, text) + blue + price + reset)
