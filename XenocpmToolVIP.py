    ...
    while True:
        ...
        while True:
            ...
            menu = [
                ...
                "{04}: Change ID              ",
                "{05}: Change Name            ",
                "{06}: Change Name (rainbow)  ",
                "{07}: Number Plates          ",
                "{08}: Account Delete         ",
                "{09}: Account Register       ",
                "{10}: Delete Friends         ",
                "{11}: Unlock All Paid Cars   ",
                "{12}: Unlock All Cars        ",
                "{13}: Unlock All Cars Siren  ",
                "{14}: Unlock W16 Engine      ",
                "{15}: Unlock All Horns       ",
                "{16}: Unlock Disable Damage  ",
                "{17}: Unlock Unlimited Fuel  ",
                "{18}: Unlock Home 3          ",
                "{19}: Unlock Smoke           ",
                "{20}: Unlock Wheels          ",
                "{21}: Unlock Animations      ",
                "{22}: Unlock Equipaments M   ",
                "{23}: Unlock Equipaments F   ",
                "{24}: Change Race Wins       ",
                "{25}: Change Race Loses      ",
                "{26}: Clone Account          ",
                "{27}: Custom HP              ",
                "{28}: Custom Angle           ",
                "{29}: Custom Tire burner     ",
                "{30}: Custom Car Millage     ",
                "{31}: Custom Car Brake       ",
                "{32}: Remove Rear Bumper     ",
                "{33}: Remove Front Bumper    ",
                "{34}: Change Account Password",
                "{35}: Change Account Email   ",
                "{36}: Custom Spoiler         ",
                "{37}: Custom BodyKit         ",
                "{38}: Unlock Premium Wheels  ",
                "{39}: Unlock Toyota Crown    ",
                "{40}: Unlock Clan Hat (m)    ",
                "{41}: Remove Head Male       ",
                "{42}: Remove Head Female     ",
                "{43}: Unlock Clan Top 1 (m)  ",
                "{44}: Unlock Clan Top 2 (m)  ",
                "{45}: Unlock Clan Top 3 (m)  ",
                "{46}: Unlock Clan Top 1 (fm) ",
                "{47}: Unlock Clan Top 2 (fm) ",
                "{48}: Unlock Mercedes Cls    ",
                "{49}: Car Inlclin            ",
                "{50}: Unlock All Lambo (IOS Only)",
                "{51}: Clone Livery           ",
                "{52}: Custom Hp (All Cars)   ",
                "{00}: Exit                  ",
            ]
            ...
            price = [
                Col.red + "1,500.00" + Col.reset,
                Col.red + "8,000.00" + Col.reset,
                Col.red + "4,500.00" + Col.reset,
                Col.red + "100.00" + Col.reset,
                Col.red + "100.00" + Col.reset,
                Col.red + "2,000.00" + Col.reset,
                Col.red + "Free" + Col.reset,
                Col.red + "Free" + Col.reset,
                Col.red + "500.00" + Col.reset,
                Col.red + "5,000.00" + Col.reset,
                Col.red + "6,000.00" + Col.reset,
                Col.red + "3,500.00" + Col.reset,
                Col.red + "4,000.00" + Col.reset,
                Col.red + "3,000.00" + Col.reset,
                Col.red + "3,000.00" + Col.reset,
                Col.red + "3,000.00" + Col.reset,
                Col.red + "4,000.00" + Col.reset,
                Col.red + "4,000.00" + Col.reset,
                ...
                Col.red + "3,000.00" + Col.reset,
                Col.red + "3,000.00" + Col.reset,
                Col.red + "1,000.00" + Col.reset,
                Col.red + "1,000.00" + Col.reset,
                Col.red + "7,000.00" + Col.reset,
                Col.red + "2,500.00" + Col.reset,
                Col.red + "1,500.00" + Col.reset,
                Col.red + "1,500.00" + Col.reset,
                Col.red + "1,500.00" + Col.reset,
                Col.red + "2,000.00" + Col.reset,
        ...
        for i in range(len(menu)):
            menu_item = menu[i]
            price_item = price[i] if i < len(price) else Col.red + "N/A" + Col.reset
            print(Colorate.Horizontal(Colors.rainbow, menu_item + " ➤ " + price_item))
